function getCategory(e) {
    var c = "";
    var b = top.window.location;
    str = new String(b);
    var d = str.indexOf(e);
    if (d != -1) {
        var f = str.substring(d);
        var g = f.indexOf("&");
        if (g == -1) {
            var d = f.indexOf("=");
            var c = f.slice(d + 1)
...
omtr_omnituredomainID = "citiintlchn";
if (location.hostname.match(/^(?:www\.)?citi(bank|corp|group)*\.(com|cn|co)(\.cn)*/)) {
    var reportSuites = "citiintlchn"
} else {
    var reportSuites = "citiintlchinadev"
}
omtr_omnitureRSID = reportSuites;
omtr_domainPeriods = 3;
omtr_internalDomain = "javascript:,citibank.com.cn";
omtr_countryID = "CN";
omtr_externalcampaignID = "ecid,cid";
omtr_internalcampaignID = "eOfferCode,icid";
omtr_charSet = "ISO-8859-1";
omtr_timezone = "+8";
omtr_currency = "CNY";
var s_account = reportSuites;
...
function s_doPlugins(a) {
    a.prop50 = "Citi Intl CN s_code - 20140405 | SiteCatalyst Base Code H25.2";
    if (a.pageType == "errorPage") {
        a.pageName = "404:" + a.wd.location;
        a.channel = "Error"
    }
    if (!a.pageType && !a.pageName) {
        a.pageName = a.getPageName()
    }
    if (!a.channel) {
        a.channel = a.channelExtract("|", 1, a.pageName)
    }
    if (!a.prop1) {
        a.prop1 = a.channelExtract("|", 2, a.pageName)
    }
    if (!a.prop2) {
        a.prop2 = a.channelExtract("|", 3, a.pageName)
    }
    if (!a.prop3) {
        a.prop3 = a.channelExtract("|", 4, a.pageName)
    }
    if (!a.prop4) {
        a.prop4 = a.channelExtract("|", 5, a.pageName)
    }
    if (!a.hier1) {
        a.hier1 = a.channelExtract("|", 10, a.pageName, 1)
    }
    a.prop9 = omtr_countryID;
    a.tempSearchPage = a.getPreviousValue(a.pageName, "s_gpv_pageName", "");
    a.prop20 = a.tempSearchPage;
    if (a.prop19) {
        a.prop19 = a.getValOnce(a.prop19, "gvo_prop19", 0);
        a.prop19 = a.prop19.toLowerCase();
        a.eVar14 = "D=c19";
        a.events = a.apl(a.events, "event1", ",", 2)
    }
    if (!a.eVar2) {
        a.eVar2 = a.getQueryParam(omtr_internalcampaignID);
        a.eVar2 = a.getValOnce(a.eVar2, "s_ev2", 0)
    }
    if (a.eVar2) {
        a.events = a.apl(a.events, "event15", ",", 2)
    }
    if (a.products) {
        a.events = a.apl(a.events, "event8", ",", 2)
    }
    a.campaign = "";
    if (!a.campaign) {
        a.campaign = a.getQueryParam(omtr_externalcampaignID);
    ...
    if (a.prop22) {
        a.eVar4 = a.prop22;
        a.events = a.apl(a.events, "event5", ",", 2)
    }
    a.prop7 = a.eVar7 = a.getTimeParting("h", omtr_timezone);
    a.prop8 = a.eVar8 = a.getTimeParting("d", omtr_timezone);
    if (a.events && (a.events + ",").indexOf("event6,") > -1) {
        a.prop15 = "start"
    }
    if (a.events && (a.events + ",").indexOf("event7,") > -1) {
        a.prop15 = "stop"
    }
    a.eVar10 = a.prop15 = a.getTimeToComplete(a.prop15, "ttc", 0);
    a.prop49 = a.wd.location.toString().toLowerCase();
    a.prop17 = a.eVar11 = a.getNewRepeat();
    a.prop18 = a.eVar13 = a.getVisitNum("m");
    a.prop5 = a.getAndPersistValue(a.prop5, "s_pers_prop5", 1825);
    if (!a.prop5) {
        a.prop5 = "anon"
    }
    a.prop6 = a.getAndPersistValue(a.prop6, "s_pers_c6", 1825);
    if (!a.prop6) {
        a.prop6 = "anon"
    }
    if (!a.prop10) {
        var b = location.pathname;
        if (b.indexOf("/cn/") != -1 || b.indexOf("/chinese/") != -1) {
            a.prop10 = "CN"
        } else {
            if (b.indexOf("/en/") != -1 || b.indexOf("/english/") != -1) {
                a.prop10 = "EN"
            } else {
                a.prop10 = ""
            }
    ...
    if (a.prop10) {
        a.prop23 = a.prop10 + ">" + a.pageName
    }
    if (a.pageName) {
        a.eVar1 = a.pageName
    }
    if (!a.server) {
        a.server = parent.window.location.host.replace(/www[0-9]*\./, "")
    }
}
