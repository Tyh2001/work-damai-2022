 var imagePath = 'images/';
        ...
        var video = {
            ...
            data: [
                ...
                { id: 19, title: '2022重整待发，把脉新经济新赛道的投资方向', date: '2022年01月10日', source: 'https://media.infinitymcn.com/citivideo.mp4', img: 'video_in_05.jpg', href: 'video.html', target: '_self' }
            ]
        };
        var comment = {
            ...
            data: [
                ...
                { id: 67, title: '关于通胀和企业盈利', date: '2021年11月04日', href: 'ccomment_old_67.html', target: '_self' },
                { id: 68, title: '2022年度展望：不可阻挡的趋势', date: '2021年12月28日', href: 'ccomment_old_68.html', target: '_self' },
                { id: 69, title: '政策紧缩背景下，科技股还有机会吗？', date: '2022年01月20日', href: 'comment.html', target: '_self' }
            ]
        };
